...
_0x0:
	.DB  0x25,0x64,0x20,0x2B,0x20,0x25,0x64,0x20
	.DB  0x3D,0x20,0x25,0x64,0x0,0x65,0x6E,0x74
	.DB  0x65,0x72,0x20,0x74,0x77,0x6F,0x20,0x6E
	.DB  0x75,0x6D,0x3A,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0022 char result[16];
; 0000 0023 int r_num_1 = 0, r_num_2 = 0, r_res = 0;
; 0000 0024 //unsigned char raw;
...
_0x3:
; 0000 0099       {
; 0000 009A       r_num_1 = PINB;
	IN   R16,22
	CLR  R17
; 0000 009B       r_num_2 = PIND;
	IN   R18,16
	CLR  R19
; 0000 009C       r_res = r_num_1 + r_num_2;
	MOVW R30,R18
	ADD  R30,R16
	ADC  R31,R17
	MOVW R20,R30
; 0000 009D       sprintf(result, "%d + %d = %d", r_num_1, r_num_2, r_res);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
...
; 0000 009F       lcd_clear();
	CALL _lcd_clear
; 0000 00A0       lcd_puts("enter two num:");
	__POINTW2MN _0x6,0
	CALL _lcd_puts
